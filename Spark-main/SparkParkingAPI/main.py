...
# Define FastAPI app instance first
app = FastAPI(
...
PARKINGS: List[Dict[str, Any]] = load_parking_excel("Spark-main/PARKING.xlsx")
    """
    ...
    results = [
        {
            ...
            "open_now": open_now  # Add open_now to the response
        }
        for p, score, open_now in zip(parking_info, scores, open_now)
    ]
